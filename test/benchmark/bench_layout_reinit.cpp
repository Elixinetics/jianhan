...
namespace jianhan::v0::layout::bench::reinit {

TEST_SUITE("Bench layout::Manager::reinit()") {
...
void processRange(Manager &manager, const Layouts &layouts, const uz beg, const uz end) {
